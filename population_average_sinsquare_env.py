...
#para el Hamiltoniano de Jaynes-Cummings con un g(t) no constante y un dipolo de radiación interractuando con un pulso
...
def population_inversion(N, omega_l, omega_0, omega_c, g, E0, n, area, ini, num_steps):
    ...
    plt.savefig('Envolvente_sin/'+"ppopulation_inversion_env_sin_g={}_E0={}_N={} {}.png".format(g,E0,N,area))
    plt.show()
    ...
    plt.plot(t, result.expect[0], label="Numero promedio de fotones",color='#20639B',lw=2)
    plt.xlabel('Tiempo',fontsize=15)
    plt.ylabel('Numero promedio de fotones',fontsize=15)
    plt.title("Jaynes-Cummings y pulso con RWA",fontsize=20)
    plt.legend(fontsize=15)
    plt.savefig('Envolvente_sin/' +"average_photons_general_g={}_E0={}_N={} {}.png".format(g,E0,N,area))
    plt.show()
...
def population_inversion_variedades(N, omega_l, omega_0, omega_c, g, E0, n, variedades, area, ini, num_steps):
    ...
    plt.savefig('Envolvente_sin/' + "Population_inversion_variedades_env_sin_g={}_E0={}_N={} {}_env_sin.png".format(g,E0,N,area))
    plt.show()
...
def average_photons_variedad(N, omega_l, omega_0, omega_c, g, E0, n, area, ini, num_steps):
    ...
    plt.savefig('Envolvente_sin/' + "Average_photons_individual_variedades_g={}_E0={}_N={} {}_env_sin.png".format(g,E0,N,area))
    plt.show()
...
def population_inversion_all(N, omega_l, omega_0, omega_c, g, E0, n, area, ini, num_steps):
    ...
    plt.title("Jaynes-Cummings y dipolo de la radiacion",fontsize=20)
    for i in range(0,N):
        plt.plot(t, resultados[i], label="Variedad ",lw=2)
    plt.plot(t, sum(resultados), label="Suma de las inversiones",lw=2)
    #plt.plot(t, result2.expect[1], label="Inversion de poblacion general",color='#173F5F',lw=2)
    plt.xlabel('Tiempo',fontsize=15)
    plt.ylabel('Inversion de poblacion',fontsize=15)
    plt.title("Jaynes-Cummings y pulso interactuando con la radiación",fontsize=20)
    #plt.legend()
    plt.savefig('Envolvente_sin' + "Population_inversion_all_variedades_g={}_E0={}_N={} {}_env_sin.png".format(g,E0,N,area))
    plt.show()
