...
plt.plot(retraso1[0], retraso1[2], label="Terminando en |e>",color='#3CAEA3')
plt.plot(retraso2[0], retraso2[2], label="Terminando en |g>",color='black')
plt.plot(retraso3[0], retraso3[2], label=r'$\frac{1}{\sqrt{2}}(|e\rangle + |g\rangle)$',color='#ED553B')
