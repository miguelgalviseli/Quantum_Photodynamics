from population_average_const_env import average_photons_variedad
import numpy as np
...
tiempos = [3200, 3300, 3400, 3500, 3600, 3700, 3800, 3900, 4000, 4100, 4200, 4300]
T = (2*n+1)*np.pi/(g)
#T=1000
#print(T)
#T=100
...
a=population_inversion_all(N, omega_l, omega_0, omega_c, g, E0, n, area, ini, num_steps,tiempos)
